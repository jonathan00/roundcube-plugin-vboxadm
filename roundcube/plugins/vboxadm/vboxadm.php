...
class vboxadm extends rcube_plugin
{
        ...
        function vboxadm_save()
        {
                ...
                $save_message = '';
                if (empty($error)) {
                        $result_array = $this->_save($user,$sa_active,$sa_kill_score,$is_on_vacation,$vacation_start,$vacation_end,$vacation_subj,$vacation_msg,$max_msg_size,$alias_active,$
alias_goto);
...
//              $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td>\n",
                        $field_id,
                        html::quote($this->gettext('spamenabled')),
...
//              $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                $out .= sprintf("<th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('spamscorerefuse')),
                        $input_spamscorerefuse->show($sa_kill_score),
                        '<br /><span class="vboxadm-explanation">' . $this->gettext('spamscorerefuseexplanation') . '. <span class="sameline">' . $this->gettext('domaindefault') . ': ' . $d
efault_sa_refuse . '.</span></span>'
                );
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('autoresponderenabled')),
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('autoresponderstartdate')),
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('autoresponderenddate')),
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('autorespondersubject')),
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('autorespondermessage')),
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('messagesize')),
                ...
                if ($this->config['user_managed_aliases']) {
                        ...
                        $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                                $field_id,
                                html::quote($this->gettext('aliasesenabled')),
                        ...
                        $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                                $field_id,
                                html::quote($this->gettext('aliasaddresses')),
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('passwordnew')),
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('passwordconfirm')),
                ...
                $out .= sprintf("<tr><th><label for=\"%s\">%s</label>:</th><td>%s%s</td></tr>\n",
                        $field_id,
                        html::quote($this->gettext('passwordcurrent')),
